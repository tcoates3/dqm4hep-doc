...
Let say you have setup a device that provide measurement of temperature and pressure every seconds. We first have to define the event model for this setup. This is straight forward :
...
<div class="info-msg">
  ...
  It is not mandatory to write the properties from the base class but highly recommended. In case you might want to optimize the buffer size, you maybe don't need do call the writeBase() method.
</div>
